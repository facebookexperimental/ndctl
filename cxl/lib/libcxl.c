...
#define CXL_MEM_COMMAND_ID_DDR_REFRESH_MODE_SET_OPCODE 0xFB2C
#define CXL_MEM_COMMAND_ID_DDR_REFRESH_MODE_SELECT_SET_PAYLOAD_IN_SIZE 4
...
#define CXL_MEM_COMMAND_ID_CXL_DDR_REFRESH_MODE_GET_OPCODE 0xFB2D
